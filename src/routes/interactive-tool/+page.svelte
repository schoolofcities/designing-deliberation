...
<div class="shell {userState.panelOpen ? "": "panel-closed"}">
    <nav class="rail">
        ...
        {#each RAIL as p}
            <div class="phase" class:locked={p.locked}>
...
<style>
    ...
    .phase.locked .navitem { color: var(--faint); }
    ...
    .pcard { border: 1px solid var(--line); border-radius: var(--r); padding: 18px 20px; background: #fff; margin-bottom: 14px; }
    .pcard .pq { font-weight: 600; margin-bottom: 12px; font-size: 15px; }
